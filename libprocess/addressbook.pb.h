...
inline double Person::id() const {
  // @@protoc_insertion_point(field_get:tutorial.Person.id)
  return id_;
}
inline void Person::set_id(double value) {
...
inline const ::tutorial::Person& AddressBook::people() const {
  ...
  return p != NULL ? *p : *reinterpret_cast<const ::tutorial::Person*>(
...
inline ::tutorial::Person* AddressBook::mutable_people() {
  ...
  if (people_ == NULL) {
    people_ = ::google::protobuf::Arena::Create< ::tutorial::Person >(
        GetArenaNoVirtual());
  }
