...
void Person::SerializeWithCachedSizes(
  ...
  // double id = 2;
  if (this->id() != 0) {
    ::google::protobuf::internal::WireFormatLite::WriteDouble(2, this->id(), output);
  }
...
::google::protobuf::uint8* Person::InternalSerializeWithCachedSizesToArray(
  ...
  // double id = 2;
  if (this->id() != 0) {
    target = ::google::protobuf::internal::WireFormatLite::WriteDoubleToArray(2, this->id(), target);
  }
  ...
  if (this->has_people()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        1, *people_, deterministic, target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:tutorial.AddressBook)
  ...
  if (from.has_people()) {
    mutable_people()->::tutorial::Person::MergeFrom(from.people());
  }
}
